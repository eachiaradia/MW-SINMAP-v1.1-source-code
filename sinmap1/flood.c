        /* flood.c  Program to implement flooding algorithm to assign flow directions and fill 
           pits/pools in a DEM.  Uses ESRI arcview format IO files.     */
        /*
          David G Tarboton
        ...
        {
          //printf("PERCENT: %d\n",0);
          int i,j,k,n,nflat,ni,ip,imin,err,jn,in,ipour,jpour;
          float fact[9];
          FILE *fp;
        ...
        /*  printf("Problem Pixels \n");   */
          printf("MESSAGE: Flats Unresolved\n");     
        ...
        /*      if(i!=0 && i!=ny-1 && j!=0 && j!=nx-1 && dir[j][i]!= -1)  */
                         ...
                         /* not on boundary  */
              {
                ...
                if(npool >= pstack)
                {
                  ...
                  {
        /*  Try enlarging   */
                    printf("\nMESSAGE: Enlarging pool stack\n");
                    pstack=(int) (pstack + nx*ny*.1);
                    if(pstack > nx*ny)
                    {
                      printf("\nERROR: Pool stack too large, exiting ...\n");
                      return(14);
                    }
                    ...
                    {
                      printf("\nERROR: Cannot reallocate pool stack, exiting ...\n");
                      return(15);
                    }
                  }
                  else
                  {
                    printf("\nERROR: Could not enlarge Pool stack\n");
                    return(16);
                  }
                }
                ipool[npool]=i;
        	...
        	if(nis >= istack )
              {
                /*  Try enlarging   */
                 ...
                 if(istack > nx*ny)
                 {
                   printf("\nERROR: is,js stack too large, exiting ...\n");
                   return(12);
                 }
                 printf("\nMESSAGE: Enlarging is,js stack\n");
